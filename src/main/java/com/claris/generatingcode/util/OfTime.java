...
public class OfTime {
	...
	private final static SimpleDateFormat sdfShortTime = new SimpleDateFormat("yyyyMMddHHmmss");
    private final static SimpleDateFormat sdfLongTime = new SimpleDateFormat("yyyyMMddHHmmssSSS");


    /**
     * 按照yyyy-MM-dd HH:mm的格式字符串
     * @param date
     * @return
     */
	...
	public static int timeDifference(String nowDate, String time) throws ParseException{
		Date start = new SimpleDateFormat("yyyy-MM-dd").parse(nowDate);
		Date end = new SimpleDateFormat("yyyy-MM-dd").parse(time);
		//获取相减后天数
    ...
    public static String getAfterHour(int hour) {
        ...
        String dateTime = new SimpleDateFormat("yyyy-MM-dd HH:mm").format(calendar.getTime());
