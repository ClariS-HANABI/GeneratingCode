...
/*window.onscroll = function(){
 if(btnid != ""){
 console.log(1);
 var thisTop = $("#"+btnid).offset().top+25;
 var thisLeft = $("#"+btnid).offset().left+28;
 $("#"+btnid).next("div").css({"left": thisLeft,"top": thisTop});
 }
 };*/
...
$(".btn-mini").click(function(){
    $(".menudiv").hide();
    btnid = $(this).attr("id");
    var thisTop = $(this).offset().top+22;
    var thisLeft = $(this).offset().left+28;
    $(this).next("div").children("ul").show();
    $(this).next("div").show();
    if(thisTop > 500){
		var ulheight = parseFloat($(this).next("div").children("ul").css("height"));
        thisTop = $(this).offset().top-ulheight-10;
        $(this).next("div").children("ul").removeClass("dropdown-caret").addClass("my-caret");
    }
    $(this).next("div").css({"left": thisLeft,"top": thisTop});
});
...
$(".btn-mini").blur(
    function(){
        ...
        setTimeout(function(){
            ...
            if(classname != "menudiv"){
                $("#"+btnid).next(".menudiv").hide();
                btnid = "";
            }
        },300);
    }
