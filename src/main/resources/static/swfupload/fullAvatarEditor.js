function getWebPath() {
    ...
    var projectName = "";
    // var localhostPaht = 'http://114.215.188.228:8088/cscp';
    // var localhostPaht = 'http://114.215.188.228:8088/cscp';
    // var localhostPaht = '';
...
function fullAvatarEditor() {
	...
	// var file			= 'http://project.haitun56.com.cn:1818/fscp/static/swfupload/fullAvatarEditor.swf';		//flash文件的路径
	var file			= getWebPath().host + '/static/swfupload/fullAvatarEditor.swf';		//flash文件的路径
	var	version			= "10.1.0";						//播放该flash所需的最低版本
	// var	expressInstall	= 'http://project.haitun56.com.cn:1818/fscp/static/swfupload/expressInstall.swf';			//expressInstall.swf的路径
	var	expressInstall	= getWebPath().host + '/static/swfupload/expressInstall.swf';			//expressInstall.swf的路径
